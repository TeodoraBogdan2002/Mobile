                              ...
                              child: ElevatedButton(
                                onPressed: () =>
                                {
                                  if(_formKey.currentState!.validate()){
                                    Navigator.pop(context,FoodStory.fromFoodStory(widget.story.id, dateValue, foodproductsValue, caloriesValue, sugarQValue, textValue))
                                  }
                                },
