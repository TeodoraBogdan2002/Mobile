...
import 'package:event_management/screens/employee_section.dart';
import 'package:event_management/widgets/notification.dart';
          ...
          children: [
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(20.0), // Change the button shape
                ),
                minimumSize: Size(200, 60), // Set the minimum size
              ),
              child: const Text(
                'Client section',
                style: TextStyle(fontSize: 18), // Change the text size
              ),
            ),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => TeamMemberSection()),
                );
              },
              style: ElevatedButton.styleFrom(
