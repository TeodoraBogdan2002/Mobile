...
import 'package:exam/screens/registration_section.dart';
...
class _HomepageState extends State<Homepage> {
  final channel = WebSocketChannel.connect(Uri.parse('ws://10.0.2.2:2419'));
  var logger = Logger();
  bool online = true;
            ...
            ElevatedButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => RegistrationSection()));
                },
                child: const Text('Registration section')),
            ElevatedButton(
                onPressed: () {
                  if (!online) {
