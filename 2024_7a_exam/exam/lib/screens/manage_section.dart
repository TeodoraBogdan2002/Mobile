...
class _ManageSectionState extends State<ManageSection> {
  ...
  void registerActivityAndShowMessage(String type) async {
    try {
      // Call the function to register activity
      await ApiService.instance.registerActivity(type);
      
      // Display a success message using SnackBar
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Activity registered successfully'),
      ...
      message(context, "Error registering activity", "Error");
    }
  }
                    ...
                    itemBuilder: ((context, index) {
                      return Card(
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              registerActivityAndShowMessage(dates[index]);
                            //   Navigator.push(
                            //       context,
                            //       MaterialPageRoute(
                            //           builder: (context) =>
