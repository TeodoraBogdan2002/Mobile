...
import 'package:project_management/screens/team_member_section.dart';
import 'package:project_management/widgets/notification.dart';
...
import 'project_manager_section.dart';
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TeamMemberSection()));
                },
